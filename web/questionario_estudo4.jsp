...
<body>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12 col-md-8 offset-md-2">
                    <h1 class="text-white mar-top-15 mar-bot-5 font-w-700"> 5 - Seu uso será focado em parte gráfica (edição de vídeos/imagem, AutoCAD e afins)?</h1>
    ...
    <script src="JS/questionario_estudo4.js"></script>
