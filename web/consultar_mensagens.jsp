...
<body>
    <nav>
        ...
        <ul>
<<<<<<< HEAD:build/web/Admin/consultar_mensagens.jsp
...
<<<<<<< Updated upstream:web/consultar_mensagens.jsp
...
>>>>>>> 446009ba2db7ec6445a43111c3ab590669df9455:build/web/consultar_mensagens.jsp
<<<<<<< HEAD:web/consultar_mensagens.jsp
>>>>>>> Stashed changes:build/web/Admin/consultar_mensagens.jsp
=======
>>>>>>> 6e0f6f1322dabeaeac3c1703342db6f7e21b849f:build/web/Admin/consultar_mensagens.jsp
        </ul>
    </nav>
    <div class="conteudo">
        <section class="geral">
