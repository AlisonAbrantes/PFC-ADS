        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12 col-md-8 offset-md-2">
                    <h1 class="text-white mar-top-15 mar-bot-5 font-w-700"> 7 - Seu uso será focado em aplicações de escritório (pacote Office e afins)?</h1>
