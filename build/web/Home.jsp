...
<html>
      ...
      <!--Fim modal-->
            ...
            <div class="banner" id="slogan">
              ...
              <div class="slogan" data-anime="left">  
                ...
                <div class="questionarioBtn">
                  <button class="botaoQuest animated forwards fadeInUp delay-3s"> Iniciar Questionário</button>
                </div>
    ...
    <div class="row featurette">
      ...
      <div class="col-md-5">
        <img class="serv1" src="imagens/b.jpg">
      </div>
    </div>
  ...
  <div class="qmsomos row featurette" id="sobre">
    ...
    <div class="col-md-5">
      <img class="qmsomosimg" src="imagens/equipe2.jpeg">      </div>
  </div>
